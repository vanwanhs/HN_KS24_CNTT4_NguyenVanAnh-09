...
function App() {
  ...
  function handleAddOrUpdate(vocab: Vocabulary) {
  ...
  return (
    <div className="container bg-gray-200 min-h-screen rounded-2xl pb-8">
      <div className='bg-white'>
        <div>
          <h1 className='flex items-center justify-center text-center text-[24px] font-semibold bg-green-500 mt-10 mx-10 rounded-3xl h-[100px] text-white'>
            <BookOpen size={45} /> Quản lý từ vựng
          </h1>
        </div>
        ...
        <div className='flex mt-4 ml-8 text-[24px] text-green-600'>
          <List size={30} className='mt-1' />
          <p className="ml-2">Danh sách từ vựng</p>
        </div>
